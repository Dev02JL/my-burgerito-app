      ...
      {open ? (
        <div className="fixed bottom-20 right-4 w-[320px] sm:w-[360px] rounded-[12px] bg-[#111] border border-white/10 shadow-2xl overflow-hidden z-50">
          <div className="flex items-center justify-between px-3 py-2 border-b border-white/10">
            ...
            <button
              type="button"
              className="h-8 w-8 rounded-md bg-white/10 hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-[var(--color-ring)]"
          ...
          <div className="px-3 py-2 border-b border-white/10 flex items-center gap-2">
            <label className="text-xs text-white/70" htmlFor="chat-channel">
              Canal
            </label>
            <select
              id="chat-channel"
          ...
          <div
            ref={listRef}
            className="h-[260px] overflow-y-auto p-3 flex flex-col gap-2"
            role="log"
            aria-live="polite"
          ...
          <div className="p-3 flex items-center gap-2">
            ...
            <button
              ...
              className={`h-10 w-10 rounded-md inline-flex items-center justify-center btn-accent ${
                !input.trim() ? 'opacity-60 pointer-events-none' : ''
              }`}
              aria-label="Envoyer"
            >
