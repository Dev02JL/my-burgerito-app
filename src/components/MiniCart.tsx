...
export default function MiniCart({ open, onClose }: Props) {
  ...
  return (
    <div
      ref={ref}
      className="absolute right-0 mt-2 w-[340px] rounded-[12px] bg-[#111] border border-white/10 shadow-xl p-3 z-50"
    >
            ...
            <div key={it.id} className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-white/70">
                  {it.price.toLocaleString('fr-FR', { style: 'currency', currency: 'EUR' })}
                </div>
              </div>
      ...
      <div className="mt-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/panier"
            className="h-9 rounded-md px-3 text-sm bg-white/10 hover:bg-white/20 inline-flex items-center"
          ...
          <Link
            ...
            className="h-9 rounded-md px-3 text-sm btn-accent inline-flex items-center"
          >
            Payer
          </Link>
        </div>
